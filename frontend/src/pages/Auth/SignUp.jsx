          ...
          <div className="relative">
            ...
            <div>
              ...
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden">
                  {formState.avatarPreview ? <img src={formState.avatarPreview} alt="Avatar preview" className="w-full h-full object-cover rounded-full" /> : <User className="w-8 h-8 text-gray-400" />}
                </div>
            ...
            <div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-6 rounded-lg font-semibold flex items-center justify-center hover:from-blue-700 hover:to-purple-700 space-x-2 transition-all duration-300 disabled:opacity-50  disabled:cursor-not-allowed mt-6"
              >
                {formState.loading ? (
                  <>
