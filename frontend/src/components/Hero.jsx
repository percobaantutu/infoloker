...
const Hero = () => {
  ...
  const stats = [
    { 
      icon: User, 
      label: t('landing.analytics.activeUsers'), 
      value: "1,200+" 
    },
    { 
      icon: Building2, 
    ...
    { 
      icon: TrendingUp, 
      label: t('landing.analytics.jobsPosted'),
      value: "5,000+" 
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-bold text-gray-800 mb-6 leading-tight pt-10"
          >
            {t('landing.hero.title')} 
            <span className="block bg-gradient-to-r from-blue-600 to-gray-900 bg-clip-text text-transparent mt-2">
              infoloker
            </span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-xl md:text-xl text-gray-600 mb-12 leading-tight mx-auto"
          >
          ...
          >
            ...
            >
              ...
              <span>{t('landing.hero.findJobs')}</span>
